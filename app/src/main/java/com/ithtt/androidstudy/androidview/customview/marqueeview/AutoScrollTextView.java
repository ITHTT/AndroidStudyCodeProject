...
public class AutoScrollTextView extends android.support.v7.widget.AppCompatTextView implements View.OnClickListener {
    ...
    public void init(Context context)
    {
        ...
        if(viewWidth == 0) {
            viewWidth = DensityUtil.getScreenDisplayMetrics(context).widthPixels-2*DensityUtil.dip2px(context,50);//获取屏幕的宽度
        }
        Log.e("zmm","屏幕的宽度-->"+ DensityUtil.getScreenDisplayMetrics(context).widthPixels);
